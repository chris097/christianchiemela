  ...
  return (
     <div>
        ...
        <div className='text-xs bg-gray-800/60 w-12 h-6 rounded-full flex justify-center items-center cursor-pointer hover:opacity-60'>
          <Link target='_blank' href="https://medium.com/@chrisfidel.international/generating-and-use-of-ssh-key-for-github-permission-denied-public-key-for-window-users-c19690d04ff0">View</Link>
        </div>
        </div>
    </div>
  )
